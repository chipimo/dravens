  ...
  render() {
    ...
    return (
      ...
      <View
        ...
        <Text
        numberOfLines={1}
          style={{ color: "#ffffff", fontSize: scale(20), marginLeft: scale(12), marginTop: scale(40) }}
        >
          {title}
        </Text>
        ...
        <Text
        numberOfLines={2}
          style={{ color: "#ffffff", fontSize: scale(15), margin: scale(5), textAlign:"center", width:screenWidth-50 }}
        >
          {subTitle}
        </Text>
        <Text
